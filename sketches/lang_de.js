...
function generate_time_string()
{
  ...
  switch(minute()) {
    ...
    case 13: case 14: if(randomizer % 2 == 0) {text+= "kurz vor viertel "; h++;} else text+= "kurz vor viertel nach "; break;
    case 15: if(randomizer % 2 == 0) {text+= "genau viertel "; h++;} else text+= "genau viertel nach "; h++; break;
    case 16: case 17: if(randomizer % 2 == 0) {text+= "kurz nach viertel "; h++;} else text+= "kurz nach viertel nach "; h++; break;
    ...
    case 46: case 47: text+= randomizer%2 ?  "kurz nach dreiviertel " : "kurz nach viertel vor "; h++; break;
